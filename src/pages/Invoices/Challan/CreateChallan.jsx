        ...
        <div className='container-fluid bg-white my-2 py-2 mx-auto '>
            <div className='container w-100'>
                <div className='col-12'>
                    <h2 className='head blue fw-boldest'>Create Challan</h2>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='col-12 row col-xl-12 col-md-12'>
                            ...
                            <div className='my-2 col-4 col-xl-6 col-md-6'>
                                <label htmlFor="" className='text-black text-danger'>Challan Order Date</label>
                                <input type="date" className='form-control' placeholder='Challan Order Date' />
                            </div>
                            <div className='my-2 col-4 col-xl-6 col-md-6'>
                                <label htmlFor="" className='text-black text-danger'>Challan Dispatch Date</label>
                                <input type="date" className='form-control' placeholder='Challan Dispatch Date ' />
                            </div>
                        </div>
                        <div className='col-12 row col-xl-12 col-md-12'>
