                    ...
                    <div className='row'>
                        <div className='purchaseOrder'>
                            ...
                            <div className='col-12 my-2 py-2 head-section text-center px-2'>
                                ...
                                <div className="col-6">
                                    <h2 className='head blue fw-boldest'>Purchase Order</h2>
                                </div>
                            </div>
                            {/* Company Info */}
                            ...
                            <div className='col-12 company-info col-md-12'>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='my-2 col-6'>
                                        <input type="text" className='form-control' placeholder='Vendor Address' />
                                    </div>
                                    <div className='my-2 col-6'>
                                        <input type="text" className='form-control' placeholder='Vendor Email' />
                                    </div>
                                    <div className='my-2 col-6'>
                                        <input type="text" className='form-control' placeholder='Vendor Contact Number' />
                                    </div>
                                </div>
                            </div>
                            {/* Product table */}
